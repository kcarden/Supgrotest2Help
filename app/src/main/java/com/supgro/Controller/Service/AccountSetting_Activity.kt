        ...
        userRef.addValueEventListener(object: ValueEventListener {
            ...
            override fun onDataChange(p0: DataSnapshot) {
                ...
                if (p0.exists()){
                   ...
                   Glide.with(this@AccountSetting_Activity).load(user!!.image).placeholder(R.drawable.add_profile_image).into(add_account_setting_image)

                    username_account_setting_txt.setText(user.username)
                    fullname_account_setting_txt.setText(user.fullname)
                    about_account_setting_txt.setText(user.about)
