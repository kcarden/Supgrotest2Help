...
import com.supgro.Controller.Adapter.Comments_Adapter
        ...
        userRef.addValueEventListener(object: ValueEventListener {
            ...
            override fun onDataChange(p0: DataSnapshot) {
                ...
                if (p0.exists()){
                    ...
                    Glide.with(this@CommentsActivity).load(user!!.image).placeholder(R.drawable.add_profile_image).into(profile_image_comment)
